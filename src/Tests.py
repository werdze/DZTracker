...
class TestMethods(unittest.TestCase):
    ...
    def test_API_get(self):
        URL = "http://127.0.0.1:5000/alcohol"
    ...
    def test_API_single_get(self):
        ...
        URL = "http://127.0.0.1:5000/addAlcohol"
        r = requests.post(url=URL, data=json.dumps(json_data))
        self.assertTrue(r.status_code == 200)

        URL = "http://127.0.0.1:5000/alcohol/testy"
        r = requests.get(url=URL)
    ...
    def test_API_put(self):
        ...
        URL = "http://127.0.0.1:5000/editAlcohol/" + str(id)
    ...
    def test_API_delete(self):
        ...
        URL = "http://127.0.0.1:5000/deleteAlcohol/" + str(id)
    ...
    def test_API_download_backup(self):
        URL = "http://127.0.0.1:5000/downloadBackupFile"
        r = requests.get(url=URL)
        data = r.json()
        self.assertTrue(len(data) > 0)
    ...
    def test_API_restore_backup(self):
        ...
        URL = "http://127.0.0.1:5000/restoreBackup"
